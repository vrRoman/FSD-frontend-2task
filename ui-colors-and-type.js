...
pug_mixins["color"] = pug_interp = function(name, hex, demoColor){
var block = (this && this.block), attributes = (this && this.attributes) || {};
let demoClassName = `color__demo color__demo_${demoColor}`;
pug_html = pug_html + "\n";
pug_html = pug_html + pug_indent.join("");
...
pug_mixins["type"] = pug_interp = function(name, text, headerType){
var block = (this && this.block), attributes = (this && this.attributes) || {};
let nameClassName = 'type__name';
if (headerType) {
    nameClassName += ` type__name_type_${headerType}`;
}
pug_html = pug_html + "\n";
pug_html = pug_html + pug_indent.join("");
...
pug_indent.push('            ');
pug_mixins["color"]('Dark Shade 100%', '#1F2041', 'dark-shade-100');
pug_indent.pop();
pug_html = pug_html + "\n          \u003C\u002Fdiv\u003E\n          \u003Cdiv class=\"colors__color\"\u003E";
pug_indent.push('            ');
pug_mixins["color"]('Dark Shade 75%', '#1F2041', 'dark-shade-75');
pug_indent.pop();
pug_html = pug_html + "\n          \u003C\u002Fdiv\u003E\n          \u003Cdiv class=\"colors__color\"\u003E";
pug_indent.push('            ');
pug_mixins["color"]('Dark Shade 50%', '#1F2041', 'dark-shade-50');
pug_indent.pop();
pug_html = pug_html + "\n          \u003C\u002Fdiv\u003E\n          \u003Cdiv class=\"colors__color\"\u003E";
pug_indent.push('            ');
pug_mixins["color"]('Dark Shade 25%', '#1F2041', 'dark-shade-25');
pug_indent.pop();
pug_html = pug_html + "\n          \u003C\u002Fdiv\u003E\n          \u003Cdiv class=\"colors__color\"\u003E";
pug_indent.push('            ');
pug_mixins["color"]('Dark Shade 5%', '#1F2041', 'dark-shade-5');
pug_indent.pop();
pug_html = pug_html + "\n          \u003C\u002Fdiv\u003E\n          \u003Cdiv class=\"colors__color\"\u003E";
pug_indent.push('            ');
pug_mixins["color"]('Purple', '#BC9CFF', 'purple');
pug_indent.pop();
pug_html = pug_html + "\n          \u003C\u002Fdiv\u003E\n          \u003Cdiv class=\"colors__color\"\u003E";
pug_indent.push('            ');
pug_mixins["color"]('Green', '#6FCF97', 'green');
pug_indent.pop();
...
pug_mixins["type"]('Body',
                        'This is the body text which is used for most<br>of the design, like ' +
                        'paragraphs, lists, etc.', false);
pug_indent.pop();
