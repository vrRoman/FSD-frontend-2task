...
pug_indent.push('    ');
pug_mixins["datepicker"](true, ['Прибытие', 'Выезд'], false, false);
pug_indent.pop();
pug_html = pug_html + "\n  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E\n  ";
...
pug_indent.push('    ');
pug_mixins["dropdown"]('Сколько гостей', 'Гости', 'popup', {
                className: false,
                items: {
                    item1: {
                        name: 'Взрослые',
...
pug_indent.push('    ');
pug_mixins["button"]('Подобрать номер', 'button_extended');
pug_indent.pop();
pug_html = pug_html + "\n  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E\n";
...
// EXTERNAL MODULE: ./src/pages/ui-kit/cards/cards.pug
var cards = __webpack_require__(54);
...
// EXTERNAL MODULE: ./src/pages/ui-kit/cards/cards.sass
var cards_cards = __webpack_require__(55);
...
var rate_button = __webpack_require__(19);
