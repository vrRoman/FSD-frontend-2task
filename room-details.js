...
var LikeButton = /*#__PURE__*/function () {
  ...
  _createClass(LikeButton, [{
    ...
    value: function getNumberElem() {
      var numberElemSelector = '.js-like-button__number';
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _common_blocks_like_button_like_button__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29);
/* eslint-disable no-unused-vars */

$('.js-like-button').each(function init() {
  var likeButton = new _common_blocks_like_button_like_button__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"](this);
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0)))
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _common_blocks_booking_card_booking_card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26);
/* eslint-disable no-unused-vars */

$('.js-booking-card').each(function init() {
  var bookingCard = new _common_blocks_booking_card_booking_card__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"](this);
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0)))
...
"use strict";
/* harmony import */ var _common_blocks_like_button_init__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(36);
...
"use strict";
/* harmony import */ var chart_js_dist_Chart_bundle_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60);
...
var DonutChart = /*#__PURE__*/function () {
  ...
  _createClass(DonutChart, [{
    key: "init",
    value: function init() {
      var ctx = this.getChartElem().getContext('2d'); // eslint-disable-next-line no-unused-vars
    ...
    value: function getChartElem() {
      var chartSelector = '.js-donut-chart__canvas';
...
pug_html = pug_html + "\n  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"icon-text-list__item\"\u003E\u003Ci class=\"icon-text-list__icon material-icons\"\u003E" + (pug.escape(null == (pug_interp = item.iconName) ? "" : pug_interp)) + "\u003C\u002Fi\u003E\n    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"icon-text-list__title\"\u003E" + (pug.escape(null == (pug_interp = item.title) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\n    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"icon-text-list__description\"\u003E" + (pug.escape(null == (pug_interp = item.description) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\n  ";
pug_html = pug_html + pug_indent.join("");
...
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Ccanvas class=\"donut-chart__canvas js-donut-chart__canvas\" width=\"126\" height=\"126\"\u003E\u003C\u002Fcanvas\u003E\n    ";
pug_html = pug_html + pug_indent.join("");
...
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"like-button__number js-like-button__number\"\u003E" + (pug.escape(null == (pug_interp = likesNum) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"comment__user-name\"\u003E" + (pug.escape(null == (pug_interp = userName) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\n    ";
pug_html = pug_html + pug_indent.join("");
...
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"room-info__name\"\u003E\u003Cspan class=\"room-info__number-sign\"\u003E№\u003C\u002Fspan\u003E";
let numberClassName = 'room-info__number';
let text = '';
if (isNameSmall) {
    numberClassName += ' room-info__number_size_small';
    text = number;
}
pug_html = pug_html + "\n    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + ("\u003Cdiv" + (pug.attr("class", pug.classes([numberClassName], [true]), false, true)) + "\u003E" + (pug.escape(null == (pug_interp = text) ? "" : pug_interp)));
if ((!isNameSmall)) {
pug_indent.push('      ');
pug_mixins["heading"]({
                        text: number,
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\n  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"room-info__price\"\u003E" + (pug.escape(null == (pug_interp = `${price}₽`) ? "" : pug_interp)) + "\u003Cspan class=\"room-info__price-measure\"\u003Eв сутки\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cbutton" + (pug.attr("class", pug.classes([className], [true]), false, true)) + "\u003E\u003Ca" + (" class=\"button__link\""+pug.attr("href", hasLink ? link : false, true, true)) + "\u003E";
pug_indent.push('    ');
...
pug_html = pug_html + "\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"booking-card js-booking-card\"\u003E";
pug_indent.push('  ');
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\n  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"booking-card__guests js-booking-card__guests\"\u003E";
pug_indent.push('    ');
pug_mixins["dropdown"]({
                inputOptions: {
                    value: '3 гостя',
...
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + ("\u003Cdiv class=\"booking-card__item-text\"\u003E" + (null == (pug_interp = item.text) ? "" : pug_interp));
if ((item.hasTooltip)) {
pug_html = pug_html + "\n        ";
pug_html = pug_html + pug_indent.join("");
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\n      ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"booking-card__item-price\"\u003E" + (pug.escape(null == (pug_interp = `${item.price}₽`) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\n    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
      }
  } else {
...
pug_html = pug_html + "\n      ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv\u003E" + (pug.escape(null == (pug_interp = item.name) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\n      ";
pug_html = pug_html + pug_indent.join("");
...
pug_html = pug_html + "\n";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"social-links\"\u003E\u003Ca class=\"social-links__link\" href=\"change-me\"\u003E\u003Ci class=\"social-links__icon fab fa-twitter\"\u003E\u003C\u002Fi\u003E\u003C\u002Fa\u003E\u003Ca class=\"social-links__link\" href=\"change-me\"\u003E\u003Ci class=\"social-links__icon fab fa-facebook-square\"\u003E\u003C\u002Fi\u003E\u003C\u002Fa\u003E\u003Ca class=\"social-links__link\" href=\"change-me\"\u003E\u003Ci class=\"social-links__icon fab fa-instagram\"\u003E\u003C\u002Fi\u003E\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E";
};
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _common_blocks_donut_chart_donut_chart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59);
/* eslint-disable no-unused-vars */

$('.js-donut-chart').each(function init() {
  var donutChart = new _common_blocks_donut_chart_donut_chart__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"](this);
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0)))
...
var room_details = __webpack_require__(88);

// EXTERNAL MODULE: ./src/pages/website-pages/room-details/room-details.sass
var room_details_room_details = __webpack_require__(89);
...
// EXTERNAL MODULE: ./src/common.blocks/comment/comment.js
var comment = __webpack_require__(47);

// EXTERNAL MODULE: ./src/common.blocks/donut-chart/init.js
var init = __webpack_require__(90);

// EXTERNAL MODULE: ./src/common.blocks/header/init.js
var header_init = __webpack_require__(18);

// EXTERNAL MODULE: ./src/common.blocks/booking-card/init.js
var booking_card_init = __webpack_require__(42);
